...
type mntcUsersslohDocumentsGitHubmovingOolongsrccomponentsAboutAboutSectionJsx901426352QueryVariables = Exact<{ [key: string]: never; }>;


type mntcUsersslohDocumentsGitHubmovingOolongsrccomponentsAboutAboutSectionJsx901426352Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

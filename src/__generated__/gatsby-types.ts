...
declare namespace GatsbyTypes {
    ...
    type SitePluginPluginOptions = {
        ...
        readonly fonts: Maybe<
            ReadonlyArray<Maybe<SitePluginPluginOptionsFonts>>
        >
        readonly name: Maybe<Scalars["String"]>
    ...
    type EpisodeFragment = Pick<MarkdownRemark, "html" | "id"> & {
    ...
    type mntcUsersslohDocumentsGitHubmovingOolongsrctemplatesPostPageTemplateJsx873388545Query = {

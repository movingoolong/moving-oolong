...
enum SiteFieldsEnum {
  ...
  siteMetadata___rssMetadata___site_url = 'siteMetadata.rssMetadata.site_url',
  siteMetadata___rssMetadata___feed_url = 'siteMetadata.rssMetadata.feed_url',
  siteMetadata___rssMetadata___title = 'siteMetadata.rssMetadata.title',
  siteMetadata___rssMetadata___image_url = 'siteMetadata.rssMetadata.image_url',
  siteMetadata___rssMetadata___copyright = 'siteMetadata.rssMetadata.copyright',
  port = 'port',
  host = 'host',
...
enum SitePageFieldsEnum {
  ...
  context___imgsrc = 'context.imgsrc',
  context___nextTitle = 'context.nextTitle',
  context___nextSlug = 'context.nextSlug',
  context___prevTitle = 'context.prevTitle',
  context___prevSlug = 'context.prevSlug',
...
type SitePluginPluginOptionsQueriesFilterInput = {
  readonly query: Maybe<StringQueryOperatorInput>;
  readonly indexName: Maybe<StringQueryOperatorInput>;
};

type SitePluginPluginOptionsQueriesFilterListInput = {
...
type Unnamed_1_Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };
...
type Unnamed_2_Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        ...
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'date' | 'category' | 'imgsrc'>> }
...
type mntcUsersslohDocumentsGitHubmovingOolongsrcpagesaboutJsx1224766951QueryVariables = Exact<{ [key: string]: never; }>;


type mntcUsersslohDocumentsGitHubmovingOolongsrcpagesaboutJsx1224766951Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'html' | 'id'>
...
type mntcUsersslohDocumentsGitHubmovingOolongsrctemplatesPostPageTemplateJsx4217295899QueryVariables = Exact<{
  slug: Maybe<Scalars['String']>;
  imgsrc: Maybe<Scalars['String']>;
}>;


type mntcUsersslohDocumentsGitHubmovingOolongsrctemplatesPostPageTemplateJsx4217295899Query = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'html' | 'id'>
...
type FluidImageFragment = { readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> };
...
type mntcUsersslohDocumentsGitHubmovingOolongsrcpagesepisodesJsx3817841774QueryVariables = Exact<{ [key: string]: never; }>;


type mntcUsersslohDocumentsGitHubmovingOolongsrcpagesepisodesJsx3817841774Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'html' | 'id'>
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'date' | 'category' | 'imgsrc'>> }
...
type AllEpisodesQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'html' | 'id'>
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'date' | 'category' | 'imgsrc'>> }
      ) }> }, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: FluidImageFragment }> } };
...
type Unnamed_3_Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixed_noBase64Fragment> }> }> };

type Unnamed_4_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_4_Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'html' | 'id'>
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'date' | 'category' | 'imgsrc'>> }
      ) }> }, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'id' | 'absolutePath'>

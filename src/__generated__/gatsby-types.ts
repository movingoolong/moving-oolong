...
declare namespace GatsbyTypes {
    ...
    type SitePluginPluginOptions = {
        ...
        readonly queries: Maybe<
            ReadonlyArray<Maybe<SitePluginPluginOptionsQueries>>
        >
    ...
    type Unnamed_1_Query = {
        readonly markdownRemark: Maybe<EpisodeFragment>
        readonly file: Maybe<FluidImageFragment>
    }

    type EpisodeFragment = Pick<MarkdownRemark, "excerpt" | "html" | "id"> & {
        readonly fields: Maybe<Pick<MarkdownRemarkFields, "slug">>
        readonly frontmatter: Maybe<
            Pick<
                MarkdownRemarkFrontmatter,
                "title" | "tags" | "date" | "category" | "imgsrc" | "link"
            >
        >
    }

    type FluidImageFragment = Pick<File, "absolutePath" | "relativePath"> & {
